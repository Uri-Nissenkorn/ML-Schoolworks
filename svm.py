...
#     svm.SVC(C=C,kernel='poly', degree=2).fit(X,y),
#     svm.SVC(C=C,kernel='poly', degree=3).fit(X,y),
# ]
# names = [
#     "linear",
#     "poly-2",
...
# #===C==============
# y = np.array([-yi if randrange(10)==0 else yi if yi < 0 else yi for yi in y])

# models = [
#     svm.SVC(C=C,kernel='poly', degree=2, coef0=1).fit(X,y),
#     svm.SVC(C=C,kernel='rbf', gamma=1).fit(X,y),
#     svm.SVC(C=C,kernel='rbf', gamma=10).fit(X,y),
#     svm.SVC(C=C,kernel='rbf', gamma=20).fit(X,y),
# ]
# names = [
#     "poly-2",
#     "rbf-5",
